...
export declare const DAI_NOVA_SEPOLIA: Token;
export declare const USDC_NOVA_SEPOLIA: Token;
export declare const UNI_GOERLI: Token;
export declare const DAI_NOVA_MAINNET: Token;
export declare const USDC_NOVA_MAINNET: Token;
...
export declare const UT3_NOVA_SEPOLIA: Token;
